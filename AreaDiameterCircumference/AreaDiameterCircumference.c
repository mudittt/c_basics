...
float Diameter(int p, int q, int r, int s)
{
    int temp1, temp2;
    double temp3;
    temp1 = pow((r - p), 2);
    ...
    printf("\nThe diameter of this circle is : %f\n", temp3);
}
...
{
    printf("\nThe area of the circle is : %f\n", 3.14 * hehe(a, b, c, d) * hehe(a, b, c, d));
}

float CirCumFerence(float (*hehe)(int, int, int, int), int a, int b, int c, int d)
{
